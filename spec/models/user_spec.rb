...
RSpec.describe User, type: :model do
  ...
  context 'ユーザ登録ができない場合' do
    ...
    it '名字（読み）が空だとユーザ登録ができない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("Last reading name can't be blank",
                                                    'Last reading name Full-width katakana characters')
    end
    ...
    it '名前（読み）が空だとユーザ登録ができない' do
      ...
      @user.valid?
      expect(@user.errors.full_messages).to include("First reading name can't be blank",
                                                    'First reading name Full-width katakana characters')
    end
